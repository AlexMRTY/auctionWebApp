...
/////////////////////////////////////
// // Register the AppIdentityDbContext for the user database
// builder.Services.AddDbContext<AppIdentityDbContext>(options =>
//     options.UseMySQL(builder.Configuration.GetConnectionString("IdentityDbConnection")));
//
// // Use AddIdentity with a custom user (AppIdentityUser) and role (IdentityRole)
// builder.Services.AddIdentity<AppIdentityUser, IdentityRole>()
//     .AddEntityFrameworkStores<AppIdentityDbContext>()
//     .AddDefaultTokenProviders();  // Adds default token providers (for reset passwords, etc.)
//
// // Optionally configure Identity options (like requiring account confirmation)
