...
namespace auctionWebApp.Migrations
{
    ...
    [Migration("20241014192622_Initial")]
            ...
            modelBuilder.Entity("auctionWebApp.persistence.AuctionItemDb", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2024, 10, 17, 21, 26, 21, 850, DateTimeKind.Local).AddTicks(7836),
                            IsOpen = true,
                            Name = "Bicycle",
                            StartTime = new DateTime(2024, 10, 14, 21, 26, 21, 850, DateTimeKind.Local).AddTicks(7789),
                            StartingPrice = 100m,
                            UserName = "alexmrty"
                        });
                });
            ...
            modelBuilder.Entity("auctionWebApp.persistence.BidDb", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 150m,
                            AuctionItemId = -1,
                            PlacedTime = new DateTime(2024, 10, 14, 21, 26, 21, 850, DateTimeKind.Local).AddTicks(8015),
                            UserName = "alexmrty"
                        },
                        new
                        {
                            ...
                            Amount = 200m,
                            AuctionItemId = -1,
                            PlacedTime = new DateTime(2024, 10, 14, 21, 26, 21, 850, DateTimeKind.Local).AddTicks(8024),
                            UserName = "anderslm"
                        });
                });
